...
from app_api import models as api_models
...
class VariantItemSerializer(serializers.ModelSerializer):
    ...
    def __init__(self, *args, **kwargs):
        ...
        """
        depth is an optional attribute in the Meta class.
        It tells the serializer how deep to automatically traverse relationships (e.g., foreign keys or many-to-many fields).
        depth = 0: Only serialize the primary model.
        depth = 1: Also serialize immediate related models.
        depth = 2+: Continue nesting related models recursively.
        """
        # If the request exists and is a POST request, set depth to 0 (flat serialization)
        if request and request.method == "POST":
            self.Meta.depth = 0
        else:
            # For other request types (e.g., GET), use a deeper nested serialization
            self.Meta.depth = 3
